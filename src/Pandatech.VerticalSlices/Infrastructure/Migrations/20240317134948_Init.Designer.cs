...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pandatech.VerticalSlices.Domain.Entities.UserEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Pandatech.VerticalSlices.Domain.Entities.UserTokenEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Pandatech.VerticalSlices.Domain.Entities.UserTokenEntity", b =>
                {
                    b.HasOne("Pandatech.VerticalSlices.Domain.Entities.UserTokenEntity", "PreviousUserTokenEntity")
                        .WithOne()
                        .HasForeignKey("Pandatech.VerticalSlices.Domain.Entities.UserTokenEntity", "PreviousUserTokenId")
                        .HasConstraintName("fk_user_tokens_user_tokens_previous_user_token_id");

                    b.HasOne("Pandatech.VerticalSlices.Domain.Entities.UserEntity", "User")
                        .WithMany("UserTokens")
